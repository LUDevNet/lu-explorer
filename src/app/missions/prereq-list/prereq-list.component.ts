...
@Component({
  selector: 'app-prereq-list',
  templateUrl: './prereq-list.component.html',
  styleUrls: ['./prereq-list.component.css']
})
export class PrereqListComponent implements OnInit {

  data: any;

  constructor() { }

  @Input() set string(value: string) {
    this.data = this.parsePrereqString(value);
  }
